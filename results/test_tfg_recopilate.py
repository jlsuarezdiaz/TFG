...
dim_results = {}
datasets_dim = ['sonar','movement_libras','spambase']
...
for k in [3,5,7]:
    ...
    for d in datasets_dim:
        ...
        #dim_results[k][d]['train'].to_latex('./results/dim-exp-'+str(d)+'-train-'+str(k)+'nn.tex')
        #dim_results[k][d]['test'].to_latex('./results/dim-exp-'+str(d)+'-test-'+str(k)+'nn.tex')
