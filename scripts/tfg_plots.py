...
#f0.suptitle(r'1-NN',fontsize=20)
#fa.suptitle(r'$M=\begin{pmatrix}1 & 0 \\ 0 & 1 \end{pmatrix}$',fontsize=20)
#fb.suptitle(r'$M \approx \begin{pmatrix} 0 & -0.004 \\ -0.004 & 27.5 \end{pmatrix}$',fontsize=20)
#fc.suptitle(r'$L \approx \begin{pmatrix} -0.0001 & 0.073 \\ -0.0008 & 5.24 \end{pmatrix}$',fontsize=20)
np.random.seed(28)
...
fa.suptitle(r'$L=\begin{pmatrix}1 & 0 \\ 0 & 1 \end{pmatrix}$',fontsize=20)

fb, axb = plt.subplots(figsize=(12,12))
axb.set_xlim((-1.2,1.2))
axb.set_ylim((-1.2,1.2))
fb.suptitle(r'$L=\begin{pmatrix}\sqrt{2}/2 & \sqrt{2}/2 \\ \sqrt{2}/2 & -\sqrt{2}/2 \end{pmatrix}$',fontsize=20)
axb.scatter(LLX[:,0],LLX[:,1])

fc, axc = plt.subplots(figsize=(12,12))
axc.set_xlim((-1.2,1.2))
axc.set_ylim((-1.2,1.2))
fc.suptitle(r'$L=\begin{pmatrix}\sqrt{2}/2 & \sqrt{2}/2\end{pmatrix}$',fontsize=20)
